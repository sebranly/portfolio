...
const projects: Project[] = [
  {
    description: [
      '2D board game adaptation of CTR',
      'same characters',
      'one track: crash cove',
      'all items/weapons',
      'cheat code for penta'
    ],
  ...
  },
  {
    ...
    description: [
      'sokoban',
      '2D-isometric from scratch',
      'level editor with game rules (one spawn, etc.), has to be completed to validate a level',
      'adventure mode with 20 levels of increasing difficulty',
      'progression with save'
    ],
  ...
  {
    description: [
      'challenge on openclassrooms',
      'can edit all rules so not just conway',
      'two themes',
      'zoom for drawing easily'
    ],
    title: 'myLife',
  ...
  {
    description: [
      'Create 16x16 or 32x32 pixel art',
      'save it on your ds',
      'export it on your computer 1024x1024',
      'inspired by animal crossing ds and mario kart ds'
    ],
    title: 'myPixelArt',
  ...
  },
  {
    ...
    description: [
      'tetrispace++',
      'multiple themes (classic, gameboy, bubble bobble, Super mario bros, playstation, dice, etc.)',
      'player card with avatar (actually coming from myPixelArt), caption, background color',
      'challenges to unlock all of it',
      'experiment with 3D',
      'music'
    ],
    title: 'myTetris',
  ...
  },
  {
    ...
    description: [
      'idea from scratch',
      'tetris gameplay with english-french translations',
      'letter addition, letter removal, letter in between, anagrams',
      '1300 available words'
    ],
    title: 'myEnglishGame',
  ...
  },
  {
    ...
    description: [
      ...
      'all vehicle models from GTAV',
      'can create an account, post and rate pictures of vehicles',
      'admin module',
      '50 autres membres qui ont déjà envoyé plus de 250 images et pas moins de 2400 notes !'
    ],
