...
const en = {
  translation: {
    ...
    projects: {
      aoc: {
        desc1: "Having liked the 2017 edition of Advent of Code, I continue the adventure by retroactively solving puzzles from 2016.",
        desc2: "This time I pick JavaScript rather than C, as the latter is too verbose for a challenge based on time completion. I create lots of useful helper files as I solve problems one by one.",
        desc3: "These files and functions comes in handy when working on 2018 edition in December 2018 as the puzzles come up daily.",
        subtitle: 'Series of challenges for different years'
      },
      aoc2017: {
        desc1: 'Some former classmates mention Advent of Code to me, a series of daily programming puzzles in December.',
        desc2: 'We decide to compete against each other in a friendly way and I go with the language I learnt programming with, C.',
        desc3: 'After some perseverance and many helper files created, I finish the 25th and last puzzle during this fun experience.',
      ...
      connectFour: {
        ...
        desc3: 'The final project includes a 2-player mode as well as a basic artificial intelligence in order to play against the computer.',
        subtitle: "Play against your friend or the computer"
      },
      coolr: {
        desc1: "As a birthday gift, I create a puzzle game based on mixing colors.",
        desc2: "The game features several puzzles based on different video games. It focuses a lot on the player's observation skills. That's all the clues you'll get.",
      ...
      // TODO: video
      ctrOcr: {
        desc1: "Several years later and still a fan of the Crash Team Racing video game which got a remake on PlayStation 4, I'm active on Discord communities of French players.",
        desc2: "Also interested by optical character recognition, I combine both interests and create a website in which users upload screenshots of in-game end results, and in return they obtain a leaderboard of all racing positions.",
      ...
      eightQueensPuzzle: {
        desc1: 'For school, we work on a famous chess puzzle. The goal is to place eight queens on a chessboard so that no two queens threaten each other.',
        desc2: 'We start generating all the permutations for a set of letters thanks to a stack.',
        desc3: "After learning that the eight queens puzzle is actually close to letters' permutations, we solve the main puzzle.",
      ...
      kaleidoscope: {
        desc1: "I really liked the interactive movie Bandersnatch on Netflix. When I heard of Kaleidoscope on Netflix, a story told in a non-linear way, I wanted to create a quick website about it.",
        desc2: "The website allows users to modify the viewing order of the total of eight episodes of the TV show.",
        desc3: "Inspired by Wordle, I also include a sharing feature so that users can discuss about their viewing order with other users on social media.",
        subtitle: "Share your non-linear viewing order"
      },
      magicSquares: {
        desc1: 'After playing the first episode of Professor Layton, a puzzle adventure video game, I learn the existence of magic squares.',
      ...
      maze: {
        ...
        desc2: 'I follow an algorithm in order to generate perfect mazes (as imperfect mazes can easily be generated by starting from a perfect one then breaking some of its walls).',
        desc3: 'The C implementation I come up with also includes the path solution to go from the top left hand corner of the maze to its bottom right hand corner.',
      ...
      projectEuler: {
        desc1: 'In parallel of the other challenge called Advent of Code, I take part in some challenges from Project Euler.',
        desc2: "I complete the first 20+ challenges by using Python this time.",
        subtitle: "Some computational problems"
      },
      resume: {
        desc1: 'Trying to come up with a funny résumé idea for a job search abroad, I spend a day creating a quick and dirty online résumé.',
        desc2: 'I take inspiration from ebay in order to create a parody of it in which the product is myself. It also marks my first experience with GitHub Pages.',
      ...
      templateTs: {
        ...
        desc2: "One afternoon, I create a repository template which allows me to start websites hosted for free on GitHub Pages with up-to-date technologies, in a fast way.",
        desc3: "Thanks to this template, lots of websites are started including Kaleidoscope, DMZ and this Portfolio you are browsing.",
