...
const fr = {
  translation: {
    ...
    projects: {
      aoc: {
        desc1:
          "Ayant aimé l'édition 2017 d'Advent of Code, je continue l'aventure en résolvant de manière rétroactive les défis de 2016.",
        desc2:
      ...
      aoc2017: {
        desc1:
          'Des anciens camarades de classes mentionnent Advent of Code, un ensemble de puzzles journaliers en Décembre.',
        desc2:
          "Nous décidons de nous lancer dans cette compétition et je choisis le langage avec lequel j'ai appris à programmer, le C.",
        desc3:
          "Avec persévérance et après avoir créé plusieurs fichiers pour m'aider (piles, files, etc.), je viens à bout du 25ème et dernier puzzle pendant cette bonne aventure.",
      ...
      coolr: {
        desc1:
          "En tant que cadeau d'anniversaire, je crée un jeu de puzzles basé sur le fait de mélanger des couleurs.",
        desc2:
          "Le jeu comprend plusieurs petits puzzles basés sur des jeux vidéo. Il se concentre beaucoup sur les capacités d'observation du joueur. Vous n'aurez pas davantage d'indices.",
      ...
      ctrOcr: {
        desc1:
          'Plusieurs années plus tard et toujours fan du jeu vidéo Crash Team Racing qui a reçu un remake sur PlayStation 4, je suis actif sur Discord dans des communautés de joueurs français.',
        desc2:
          "Également intéressé par la reconnaissance optique de caractères, je combine les deux intérêts en créant un site web sur lequel les utilisateurs téléchargent en amont leurs captures d'écran de fin de course, et obtiennent en retour un classement complet des positions.",
      ...
      eightQueensPuzzle: {
        desc1:
          "À l'école, nous travaillons sur un puzzle d'échecs connu. Le but est de placer huit dames de telle sorte à ce qu'aucune d'entre elles ne soit en prise.",
        desc2:
      ...
      kaleidoscope: {
        desc1:
          "Le film interactif Bandersnatch sur Netflix m'a vraiment plu. Lorsque j'ai entendu parler de Kaleidoscope sur Netflix, une histoire racontée de façon non-linéaire, je voulais créer un petit site web autour.",
        desc2:
          "Le site web permet aux utilisateurs de modifier l'ordre de visionnage des huit épisodes complets de la série télé.",
        desc3:
          "Inspiré par Wordle, j'inclus également une fonctionnalité de partage pour que les utilisateurs puissent discuter de leur ordre de visionnage en le partageant sur les réseaux sociaux.",
        subtitle: 'Partagez votre ordre de visionnage'
      },
      magicSquares: {
        desc1:
          "Après avoir joué au premier épisode de Professeur Layton, un jeu vidéo d'aventure et puzzles, j'apprends l'existence des carrés magiques.",
        desc2:
      ...
      resume: {
        desc1:
          "Essayant de trouver une idée marrante de CV pour une recherche de travail à l'étranger, je passe une journée à créer un CV en ligne dont le code est très discutable.",
        desc2:
      ...
      simpleBot: {
        ...
        desc3:
          "Après avoir lu la documentation, nous implémentons quelques uns de ses concepts (basés sur la reconnaissance de patterns), de telle sorte que le chatbot puisse reconnaître les couleurs, se rappeler du prénom de l'utilisateur, ainsi que deviner la capitale de certains pays, etc.",
        subtitle: "Exemple réduit d'un chatbot"
      },
      templateTs: {
        desc1:
          "Ayant plusieurs idées de sites web en tête, je me rends compte qu'il faudrait créer un modèle d'abord afin d'accélérer le procédé.",
        desc2:
