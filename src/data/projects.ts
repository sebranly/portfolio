...
const projects: Project[] = [
  ...
  },
  {
    contributors: [{ name: STEPHANE, roles: [Role.Designer, Role.Tester] }],
    description: [
      'projects.bobolsSokoban3d.desc1',
      'projects.bobolsSokoban3d.desc2',
      'projects.bobolsSokoban3d.desc3',
    ],
  ...
  {
    description: [
      'projects.myLife.desc1',
      'projects.myLife.desc2',
      'projects.myLife.desc3',
    ],
    title: 'myLife',
  ...
  {
    description: [
      'projects.myPixelArt.desc1',
      'projects.myPixelArt.desc2',
      'projects.myPixelArt.desc3'
    ],
    title: 'myPixelArt',
  ...
  },
  {
    ...
    description: [
      'projects.mySudokuTool.desc1',
      'projects.mySudokuTool.desc2',
      'projects.mySudokuTool.desc3',
    ],
    title: 'mySudokuTool',
  ...
  },
  {
    ...
    description: [
      'projects.myEnglishGame.desc1',
      'projects.myEnglishGame.desc2',
      'projects.myEnglishGame.desc3',
    ],
    title: 'myEnglishGame',
